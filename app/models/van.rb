class Van < ApplicationRecord
  ...
  validates :is_van_pro, presence: true
  ...
  validates :is_manual_transmission, presence: true
  ...
  validates :has_fridge, presence: true
  validates :has_wc, presence: true
  validates :has_shower, presence: true
